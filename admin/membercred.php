                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item active">
                        ...
                        <i class="fa-sharp fa-solid fa-users-gear"></i>
                            <span class="active">Member Credential</span>
                        </a>
                    </li>
                    <li class="list-group-item">
                                            ...
                                            <form action="" method="POST">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="cred_name" id="cred_name" class="form-control"
                                                            placeholder="Enter Credential" value="None">
                                                    </div>

                                                    <div class="form-group">
                                                        <label> Description </label>
                                                        <input type="text" name="m_description" id="m_description" class="form-control"
                                                            placeholder="Enter Description" value="None">
                                                    </div>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit" name="updatecred" class="btn btn-primary">Update Data</button>
                                                </div>
                                            </form>
                                ...
                                <tbody>
                                    ...
                                    <td class="d-flex justify-content-around">
                                        ...
                                        <input type="hidden" name="m_id" value="<?php echo $row->m_id?>">
                                         </a><button type="button" class="btn btn-success editbtn"><i class="fa fa-edit"></i></button>&ensp;<button class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></button>
                                        </form></td>
                                    </tr>
                                    <?php }
                                    } 
...
<script>
    $(document).ready(function () {
        $('.editbtn').on('click', function () {
            ...
            $('#cred_name').val(data[2]);
            $('#m_description').val(data[3]);
