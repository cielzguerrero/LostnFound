                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item active">
                        ...
                        <i class="fa-sharp fa-solid fa-person-circle-question"></i>
                            <span class="active">Lost and Found Item(s)</span>
                        </a>
                    </li>
                    <li class="list-group-item">
                                    ...
                                    <div class="modal-dialog" >
                                        <div class="modal-content">
                                            ...
                                            <form action="" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <input type="hidden" name="i_id" id="l_id">
                                                    <input type="hidden" name="current_image" id="current_image">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="i_itemdescription" id="i_itemdescription" class="form-control"
                                                                placeholder="Enter Item Description" required>
                                                        </div>
                                                        <div class="form-group">
                                                            <label> Location </label>
                                                            <input type="text" name="i_itemlocation" id="i_itemlocation" class="form-control"
                                                        ...
                                                        <div class="form-group">
                                                            <label> Remarks </label>
                                                            <input type="text" name="i_itemremark" id="i_itemremark" class="form-control"
                                    ...
                                    <div class="modal-dialog" >
                                        <div class="modal-content">
                                            ...
                                            <form action="" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <input type="hidden" name="i_currentuser" id="i_currentuser" value="<?=$result->username?>">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                        <button type="submit" name="reportitem" class="btn btn-primary">Add Item</button>
                                                    </div>
                                            </form>
                        ...
                        <div class="card" >
                            <div class="card-body ">
                                ...
                                <thead>
                                    ...
                                    <th style="display:none">CurrentImage</th>
                                    <th>Post Category</th>
                                    <th>Description</th>
                                    <th>Time</th>
                                    <th>Location Lost/Found</th>
                                    <th>Post Type(Lost, Found)</th>
                                    <th>Member Name</th>
                                    <th>Status (Claimed, Unclaimed</th>
                                    <th>Remarks</th>
                                    <th>Manage By</th>
                                    <th>Actions | <button class="btn btn-primary addbtn">Add</button></th>
                                    </tr>
                                </thead>
                                <tbody>
                                <?php
                                    ...
                                    <td style="display: none;"><?php echo $row->post_image?></td>
                                    ...
                                    <td class="d-flex justify-content-around">
                                        ...
                                        <input type="hidden" name="current_image" value="<?php echo $row->post_image?>">
                                        <button type="button" class="btn btn-success editbtn"><i class="fa fa-edit"></i></button><button type="submit" class="btn btn-danger btn-xs" name="deleteitem"><i class="fa fa-trash"></i></button>
                                        </form>
                                    </td>
                                    </tr>
                                    <?php }
